...
const calculator = {
 ...
 evaluate (operator) {
  if (operator === "+") {
   ...
   operator === "/") {
    if (this.currentTotal === 0) {
     this.currentTotal = parseFloat(this.numbersArray.join("")); //Avoiding division by 0
   ...
   operator === "*") {
    if (this.currentTotal === 0) {
     this.currentTotal = parseFloat(this.numbersArray.join("")); //Avoiding multiplication by 0
    } else if (parseFloat(this.numbersArray.join("")) !== 0) {
    this.currentTotal *= parseFloat(this.numbersArray.join(""));
   };
  };
